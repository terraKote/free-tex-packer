                            ...
                            <tr>
                                <td>
                                    <div className="btn back-800 border-color-gray color-white file-upload">
                                        ...
                                        <input type="file" ref={this.selectTextureInputRef}
                                               accept="image/png,image/jpg,image/jpeg,image/gif"
                                               onChange={this.selectTexture}/>
                                    </div>
                                </td>
                                <td>
                                    <div className="back-400 border-color-gray color-black sheet-splitter-info-text"
                                         ref={this.textureNameRef}>&nbsp;</div>
                                </td>
                                <td>
                                    <div className="btn back-800 border-color-gray color-white file-upload">
                    ...
                    <div className="sheet-splitter-controls">
                        <table>
                            ...
                            <tr>
                                <td>{I18.f('FORMAT')}</td>
                                <td>
                                    <select ref={this.dataFormatRef} className="border-color-gray"
                                            value={this.state.splitter.type} onChange={this.changeSplitter}>
                                        {splitters.map(node => {
                                            return (<option key={"data-format-" + node.type}
                            ...
                            <tr style={{display: displayGridProperties}}>
                                <td>{I18.f('WIDTH')}</td>
                                <td>
                                    <input type="number" ref={this.widthRef} defaultValue='64'
                            ...
                            <tr style={{display: displayGridProperties}}>
                                <td>{I18.f('HEIGHT')}</td>
                                <td>
                                    <input type="number" ref={this.heightRef} defaultValue='64'
                                           onChange={this.updateView}/>
                                </td>
                            </tr>
                            <tr style={{display: displayGridProperties}}>
                                <td>{I18.f('PADDING')}</td>
                                <td>
                                    <input type="number" ref={this.paddingRef} defaultValue='0'
                                           onChange={this.updateView}/>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div className="sheet-splitter-bottom">
                        <table>
                            ...
                            <tr>
                                {this.textureBackColors.map(name => {
                                    return (
                                        <td key={"back-color-btn-" + name}>
                                            <div
                                                className={"btn-back-color " + name + (this.state.textureBack === name ? " selected" : "")}
                                ...
                                <td>
                                    <input ref={this.rangeRef} type="range" min="0.1" max="2" step={this.step}
                                           defaultValue="1" onChange={this.changeScale}/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div>
                            <div className="btn back-800 border-color-gray color-white"
                                 onClick={this.doSplit}>{I18.f("SPLIT")}</div>
                            <div className="btn back-800 border-color-gray color-white"
                                 onClick={this.close}>{I18.f("CLOSE")}</div>
                        </div>
                    </div>
                </div>
            </div>
